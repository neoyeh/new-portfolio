...
function Home() {
    ...
    const count = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "Home.useAppSelector[count]": (state)=>state.counter.value
    }["Home.useAppSelector[count]"]);
    const { items } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
...
_s(Home, "jDxATTKvQXWjuVKvTugrXC+IzT0=", false, function() {
    return [
